        ...
        <ul className="list__def">
          <li className="list__def__item">
            ...
            <div className="list__def__def">
              ...
              held by Sun & Sand Sports is not correct, please visit the
              website. After logging onto the site through the ‘Sign In’ menu on
              the homepage, your personal information will be made available for
              review. You can then change the incorrect information under the
              ‘My Account’ section. Only you or upon your request allow the
              Customer Care department to access your personal data from the
              website using your password and User ID. This information may be
              changed online under ‘My Details’, ‘Shipping Details’, and ‘My
              Email Preferences’. You can also change or delete your saved
